...
internet_browser = "falkon"
alternate_internet_browser = "vivaldi"
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,"Control"}, "e", function () awful.spawn(alternate_file_browser) end,
              {description = "open alternative 2-sided filebrowser", group = "launcher"}),
    awful.key({ modkey,         }, "a", function () awful.spawn(internet_browser) end,
              {description = "launch internet browser", group = "launcher"}),
    awful.key({ modkey,"Control"}, "a", function () awful.spawn(alternate_internet_browser) end,
              {description = "launch alternate internet browser", group = "launcher"}),
...
clientkeys = gears.table.join(
    ...
    -- Client Layout modifications - sticky floating etc...
    awful.key({ modkey,           }, "f",
        function (c)
