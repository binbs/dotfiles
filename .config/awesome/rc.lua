...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "e", function () awful.spawn(file_explorer) end,
              {description = "open filebrowser", group = "layout"}),
    awful.key({ modkey,"Control"}, "e", function () awful.spawn("sunflower") end,
              {description = "open alternative 2-sided filebrowser", group = "layout"}),
